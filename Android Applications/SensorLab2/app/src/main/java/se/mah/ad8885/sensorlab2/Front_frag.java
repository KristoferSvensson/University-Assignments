...
*/
/**
 * All graphical components in the application, and the methods for updating them, are in this fragment.
 *//*
...
public class Front_frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnAST.setTextColor(getResources().getColor(R.color.AST));
    ...
    public void setAPIText(String pressure, String humidity, String temperature, float altitude) {
        if (usingAST) {
            apiPressureSource.setTextColor(getResources().getColor(R.color.AST));
            apiPressureSource.setText(getActivity().getString(R.string.data_from_api_with_asynctask));
            apiPressure.setTextColor(getResources().getColor(R.color.AST));
            apiHumiditySource.setTextColor(getResources().getColor(R.color.AST));
            apiHumiditySource.setText(getActivity().getString(R.string.data_from_api_with_asynctask));
            apiHumidity.setTextColor(getResources().getColor(R.color.AST));
            apiTemperatureSource.setTextColor(getResources().getColor(R.color.AST));
            apiTemperatureSource.setText(getActivity().getString(R.string.data_from_api_with_asynctask));
            apiTemperature.setTextColor(getResources().getColor(R.color.AST));
            apiAltitude.setTextColor(getResources().getColor(R.color.AST));
        } else if (usingVolley) {
